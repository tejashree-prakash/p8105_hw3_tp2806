...
knitr::opts_chunk$set(
  warning = FALSE,
  message = FALSE,
  echo = TRUE  # or FALSE if you want no code at all
)
```
...
For example, user 199948 placed order 3245316 that included “Organic
Vegetable Masala Stew” from the “soup broth bouillon” aisle on day 4 at
hour 19.
...
![](p8105_hw3_tp2806_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
